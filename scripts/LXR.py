...
class LXR ():
    ...
    def predict (self):
        ...
        print(f'======================== LXR run for {self.data_name} and {self.recommender_name}========================')
        ...
        for epoch in range(epochs):
            ...
            torch.save(explainer.state_dict(), Path(kw_dict['checkpoints_path'], f'LXR_{self.data_name}_{self.recommender_name}_{epoch}.pt'))
